...
export class QueryHandler<StoredValue = unknown> {
  ...
  public connection?: mariadb.Connection;
  ...
  public async init(): Promise<void> {
    this.connection = await mariadb.createConnection(this.options.connectionConfig);
...
export namespace QueryHandler {
  export interface Options {
    connectionConfig: mariadb.ConnectionConfig | string;
    tableName: string;
